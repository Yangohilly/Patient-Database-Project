            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        echo "<tr>";
                        echo "<td>" . $i++ . "</td>";
                        echo "<td>" . htmlspecialchars($row['doctors_id']) . "</td>";
                        echo "<td>" . htmlspecialchars($row['doctor_username']) . "</td>";
                        echo "<td>" . htmlspecialchars($row['doctor_surname']) . "</td>";
                        echo "<td>" . htmlspecialchars($row['doctor_gender']) . "</td>";
                        echo "<td>" . htmlspecialchars($row['doctor_age']) . "</td>";
                        echo "<td>" . htmlspecialchars($row['doctor_email']) . "</td>";
                        echo "<td>" . htmlspecialchars($row['doctor_phone']) . "</td>";
                        echo "<td>" . htmlspecialchars($row['doctor_address']) . "</td>";
                        echo "<td>" . htmlspecialchars($row['specialization']) . "</td>";
                        echo "<td>" . htmlspecialchars($row['doctor_emergency_contact']) . "</td>";
                        echo "<td>" . htmlspecialchars($row['doctor_date_of_joining']) . "</td>";
                        echo "</tr>";
                    }
                } else {
